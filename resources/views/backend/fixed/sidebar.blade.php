          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">inventory</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('car.view')}}" class="menu-link">
                    <div data-i18n="Account">Allcars</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('car.available')}}" class="menu-link">
                    <div data-i18n="Notifications">Cars Available</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('car.sold')}}" class="menu-link">
                    <div data-i18n="Connections">Cars Sold</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="{{route('car.category')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Car Category</div>
              </a>
            </li>

            <li class="menu-item">
              <a href="{{route('customers.view')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
            ...
            <li class="menu-item">
              <a href="{{route('payment.view')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Boxicons">Payment</div>
              </a>
            </li>
          </ul>
        </aside>